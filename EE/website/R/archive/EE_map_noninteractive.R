...
# Load Data
#------------------------------------------------------
base_path <- "C:/Users/annai/Documents/backup_computer_ec/Contratti_lavoro/EU_Temporary_agent/materiali_di_lavoro/mapadomo/Mapadomo_v2/EE/outputdata/final/"
...
#------------------------------------------------------
# Load Estonia LAU Shapefile (WGS84)
#------------------------------------------------------
shp_eu <- st_read(
...
# Output folder
#------------------------------------------------------
base_path <- "C:/Users/annai/Documents/backup_computer_ec/Contratti_lavoro/EU_Temporary_agent/materiali_di_lavoro/mapadomo/Mapadomo_v2/EE"
...
plot_map <- function(df, y, ind, tp) {
  ...
  ggplot(
    ...
    labs(
      title    = paste("Estonia –", ind),
      subtitle = paste("Type:", tp, "| Year:", y),
      fill     = ind,
      caption  = "Source: EE_regio"
    ) +
    theme_minimal() +
    theme(
